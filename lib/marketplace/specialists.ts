...
function mapApiSpecialistToUi(item: ApiSpecialist): UiSpecialist {
  ...
  return {
    ...
    nearAddress: item.nearAddress as string | undefined,
    professionalTitle: item.professionalTitle as string | undefined,
    yearsOfExperience: item.yearsOfExperience as number | undefined,
